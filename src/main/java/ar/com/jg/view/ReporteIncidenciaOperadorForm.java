...
public class ReporteIncidenciaOperadorForm {
    ...
    private void init() {
        ...
        String menuReporteIncidencia = """
                ...
                1 - INGRESAR REPORTE DE INCIDENCIA.<br>
                2 - ANULAR REPORTE DE INCIDENCIA.<br>
                3 - LISTAR REPORTES DE INCIDENCIA.<br>
                4 - SALIR.<br><br></html>""";
                                                    ...
                                                    if (JOptionPane.OK_OPTION == valorRetornado) {
                                                        ...
                                                        do {
                                                            ...
                                                            if (JOptionPane.OK_OPTION == valorRetornado) {
                                                                ...
                                                                System.out.println(descripcionProblema);
                                                                    ...
                                                                    do {
                                                                        ...
                                                                        if (JOptionPane.OK_OPTION == valorRetornado) {
                                                                            ...
                                                                            if (!validarNumero(strTiempoResolucion)) {
                                                                                ...
                                                                                } while (valorRetornado == JOptionPane.CLOSED_OPTION || fechaResolucion.isBefore(fechaAlta));
