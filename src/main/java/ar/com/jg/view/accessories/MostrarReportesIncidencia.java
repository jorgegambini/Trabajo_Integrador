    ...
    private void cargarTabla() {
        ...
        if (tecnico == null) {
            ...
            rs.listarReportesIncidencia().forEach(report -> {
                ...
                modelo.addRow(new Object[]{report.getFechaAlta(), report.getCodigoReporte(), report.getCliente(), report.getOperador(), report.getServicio(), report.getTipoProblema().name(), report.getTecnico(), report.getTiempoEstimadoResolucion(), report.getFechaPosibleResolucion(), report.getEstadoProblema().name()});
