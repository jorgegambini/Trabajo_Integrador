...
public class MostrarReportes extends JPanel {
    ...
    public MostrarReportes(EntityManager em, int optReportes, LocalDate fechaDesde, LocalDate fechaHasta, Especialidad especialidad) {
        ...
        add(scroll, "width 400:400:400, height 150:150:150");
    ...
    private void dibujarTabla() {
        ...
        String[] columnNames = {"TECNICO", "RESUELTO"};
        modelo.setColumnIdentifiers(columnNames);

        // Define el ancho de las columnas
        int[] columnWidths = {300, 100}; // Ancho en píxeles para cada columna
    ...
    private void cargarTabla() {
        ...
        System.out.println(listaReportesPorRango);
